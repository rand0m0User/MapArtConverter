...
public class LibschemAPI {
    ...
    public static void saveSchematic(String filename, Cuboid cuboid) throws IOException, DataException {
        ...
        public static Cuboid loadLitematicaSchematic(File file) throws IOException, DataException {
        return SchematicFormat.LITEMATIC.load(file);
    }

    public static Cuboid loadLitematicaSchematic(String filename) throws IOException, DataException {
        return SchematicFormat.LITEMATIC.load(new File(filename));
    }

    public static void saveLitematicaSchematic(File file, Cuboid cuboid) throws IOException, DataException {
        SchematicFormat.LITEMATIC.save(cuboid, file);
    }

    public static void saveLitematicaSchematic(String filename, Cuboid cuboid) throws IOException, DataException {
        SchematicFormat.LITEMATIC.save(cuboid, new File(filename));
    }
